      ...
      <LimitContainer>
        <PortfolioDiv>
          <PictureDiv>
            ...
            <a href="https://nex.on.fleek.co/" target={"_blank"}>
              <Img src={nexImg} style={{ maxWidth: "80vw" }} />
            </a>
          ...
          <PictureDiv>
            ...
            <a href="https://expo.on.fleek.co/" target={"_blank"}>
              <Img src={expoImg} style={{ maxWidth: "80vw" }} />
            </a>
          ...
          <PictureDiv>
            ...
            <a href="https://cacaudigital.io/" target={"_blank"}>
              <Img src={cacauDigitalImg} style={{ maxWidth: "80vw" }} />
            </a>
          ...
          <PictureDiv>
            ...
            <a href="https://telegram.me/Crazby_Bot" target={"_blank"}>
              <Img src={crazbyImg} style={{ maxWidth: "80vw" }} />
            </a>
            <PictureParagraph>Chatbot para comunidade</PictureParagraph>
          </PictureDiv>
          <PictureDiv>
            <PictureTitle>Henrique Serra</PictureTitle>
            <a href="https://henriqueserra.com.br" target={"_blank"}>
              <Img src={henriqueSerraImg} style={{ maxWidth: "80vw" }} />
            </a>
